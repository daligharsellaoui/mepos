        ...
        <div v-if="showImportWizard" class="modal-overlay" @click.self="closeWizard">
          <div class="glass-panel modal-content wizard-modal">
            ...
            <div class="wizard-footer">
              ...
              <div style="flex: 1;" />
              <button v-if="importStore.currentStep === 2 && !importStore.hasErrors" class="touch-btn touch-btn-primary" @click="importStore.goToStep(4)">
                Continuer
              </button>
              <button v-if="importStore.currentStep === 4" class="touch-btn touch-btn-primary" @click="confirmImport" :disabled="importStore.isLoading">
