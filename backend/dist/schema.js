...
async function initializeDatabase() {
    ...
    try {
        await (0, database_1.query)(exports.DDL_SCHEMA);
        console.log('Database tables verified/created successfully.');
        // Seed data if database is empty
        const checkUsers = await (0, database_1.query)('SELECT count(*) FROM users');
      ...
      `);
            await (0, database_1.query)("SELECT setval('departments_id_seq', (SELECT MAX(id) FROM departments))");
            // 3. Seed Ingredients
            await (0, database_1.query)(`
      ...
      `);
            await (0, database_1.query)("SELECT setval('ingredients_id_seq', (SELECT MAX(id) FROM ingredients))");
      ...
      `);
        ...
        (9, 'Eau Minérale', 1.50)
      `);
            await (0, database_1.query)("SELECT setval('recipes_id_seq', (SELECT MAX(id) FROM recipes))");
